...
export default {
  ...
  data() {
    return {
      ...
      pertanyaanList: [
        ...
        "Berapakah gaji terakhir anda? Dan berapa gaji & fasilitas lain yang anda harapkan apabila diterima bekerja di Perusahaan ini?",
  ...
  methods: {
          ...
          const formData = {
            ...
            foto_data_diri: this.uploadedFile
              ? {
                  ...
                  path: `http://localhost:3000/uploads/datadiri/${this.uploadedFile.name}`,
                }
              : null,
            ...
            gambaranStrukturPosisi: this.uploadedFilePosisi
              ? {
                  ...
                  path: `http://localhost:3000/uploads/gambaranposisi/${this.uploadedFilePosisi.name}`,
                }
              : null,
          };
    ...
    gambaranPosisi(event) {
      ...
      const formData = new FormData();
      formData.append("gambaranposisi", file);
